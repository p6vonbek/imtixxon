...
return(
    <header style={{backgroundColor:'blanchedalmond'}}>
        ...
        <div >
            ...
            <button style={{fontSize:'25px',textAlign:"center",border:'3px solid blue',backgroundColor:'blue',borderRadius:'10px',marginBottom:'200px', marginLeft:'780px',marginTop:'50px',width:'250px',height:'80px'}}>Sigin</button><br />
        </div>
    </header>
)
}
